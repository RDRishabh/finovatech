export default function WhatDrivesUs() {
  return (
    <section className="py-20 bg-gray-50 relative overflow-hidden bg-grid-pattern">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="relative group">
            ...
            <div 
              className="relative h-72 rounded-2xl overflow-hidden shadow-xl bg-cover bg-center transform transition-transform duration-300 group-hover:-translate-y-1"
              style={{
          ...
          <div className="relative group">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 via-black/50 to-transparent">
                <h3 className="text-xl font-bold mb-2 text-white">Our Values</h3>
                <p className="text-white/90 text-sm leading-relaxed">
          ...
          <div className="relative group">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 via-black/50 to-transparent">
                <h3 className="text-xl font-bold mb-2 text-white">Our Approach</h3>
                <p className="text-white/90 text-sm leading-relaxed">

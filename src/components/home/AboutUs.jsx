...
const AboutUs = () => {
  ...
  <div className="flex flex-col lg:flex-row items-start lg:items-stretch gap-16">
          ...
          <div className="lg:w-1/4 flex justify-center lg:justify-start lg:h-auto">
            <div className="relative h-64 lg:h-full w-80 lg:w-full">
              {/* Accent background */}
              <div className="absolute -bottom-4 -left-4 h-64 lg:h-full w-80 lg:w-full bg-primary rounded-2xl"></div>
              {/* Image container */}
              <div className="relative h-64 lg:h-full w-80 lg:w-full rounded-2xl overflow-hidden shadow-xl bg-white">
                <img
          ...
          <div className="lg:w-3/4 max-w-2xl">
            <h2 className="text-5xl font-bold italic mb-6 text-gray-900 leading-tight">
            ...
            <p className="text-2xl font-extrabold leading-snug mb-6">
